...
if d>0 then
    x1=(-b-sqrt(d))/2*a
    x2=(-b+sqrt(d)/2*a)
    printf("Le discriminant est positif et vaut ",d,"\n")
    printf("L_équation admet deux racines distinctes: x1= ",x1," et x2=",x2)
elseif d==0 then x0=-b/2*a
    printf("Le discriminant est nul \n ")
    printf("L_équation admet une racine double: x0=",x0)   
