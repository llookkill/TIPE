...
defiler=Button(fenetre,text="Commencer le défilement",command=lambda: defile()).pack(side=TOP)
bouton = Checkbutton(fenetre, text="Update continue ?")
bouton.pack()
toile.pack()
fenetre.mainloop()
